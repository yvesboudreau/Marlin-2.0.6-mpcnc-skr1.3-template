...
/* we had moved the E0 to the Bed Heater pin because we could not have 0 extruder in Marlin
...
/* was virtual definition when we needed 1 extruders
...
//
 ...
 // SERIAL_TX/RX E0/1/2 Z2 Changed from Original for MPCNC:
  ...
  #define SPINDLE_LASER_PWM_PIN            SPINDLE_LASER_ENA_PIN
#endif
...
/*
// Added from MPCNC SKR 2208-UART repo 
// Temperature Sensors
//  3.3V max when defined as an analog input
//
#define TEMP_BED_PIN       P0_23   // A0 (T0) - (67) - TEMP_BED_PIN
#define TEMP_0_PIN         P0_24   // A1 (T1) - (68) - TEMP_0_PIN
#define TEMP_1_PIN         P0_25   // A2 (T2) - (69) - TEMP_1_PIN
*/
//
// Heaters / Fans
//
// YB force fan to FAN port 2_4 to be able to use CONTROLLER_FAN on P2_03
  #define FAN_PIN          P2_04
  #define FAN1_PIN         P2_05
  #define CONTROLLER_FAN_PIN P2_03        // YB Set a custom pin for the controller fan in cfg_adv
