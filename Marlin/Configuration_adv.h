...
#define X_DUAL_STEPPER_DRIVERS
  ...
  #define X_DUAL_ENDSTOPS
    ...
    #define X2_ENDSTOP_ADJUSTMENT  -2.4
  #endif
#endif
...
#define Y_DUAL_STEPPER_DRIVERS
  ...
  #define Y_DUAL_ENDSTOPS
    ...
    #define Y2_ENDSTOP_ADJUSTMENT  -2.6
  #endif
#endif

/** Need redefining pins for E0 to BED heater and moving pin E0/E1 to E1/E2 to get them for X2/Y2 dual drivers
* for BTT_SKR_V1_3, adding them here:
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_4 "Reset Z Coordinate"
  #define USER_GCODE_4 "G92 Z0"
